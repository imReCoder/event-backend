    ...
    constructor() {
        ...
        this.isVerified = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!data.proceed) {
                    throw new httpErrors_1.HTTP400Error("User is Not Verified");
                }
                else {
        ...
        this.fetchWalletBalance = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const responseHandler = new responseHandler_1.default();
            try {
                console.log(req.userId);
                const data = yield user_model_1.default.fetchWalletBalance(req.userId);
